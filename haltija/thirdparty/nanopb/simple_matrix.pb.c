...
const pb_field_t SimpleMatrix_fields[9] = {
    ...
    PB_FIELD(  6, BOOL    , OPTIONAL, STATIC  , OTHER, SimpleMatrix, is_col_major, device_id, 0),
    PB_FIELD(  7, INT64   , OPTIONAL, STATIC  , OTHER, SimpleMatrix, timestamp_utc_millis, is_col_major, 0),
    PB_FIELD(  8, INT32   , OPTIONAL, STATIC  , OTHER, SimpleMatrix, tz_offset_millis, timestamp_utc_millis, 0),
    PB_LAST_FIELD
};
