 ...
 */
typedef enum {
	X4DRIVER_REGION_EU						= 0,
	X4DRIVER_REGION_KCC						= 1,
	X4DRIVER_REGION_AUTO					= 2,
} xtx4_region_t;
...
typedef struct
{
	...
	uint32_t normalization_offset;
	uint32_t normalization_nfactor;
	uint32_t bytes_per_counter;
	xtx4_region_t region;
	uint8_t downconvertion_enabled;
	uint8_t iq_separate;
