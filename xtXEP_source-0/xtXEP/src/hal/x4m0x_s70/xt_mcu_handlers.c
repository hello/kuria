...
//##KIH /* The prototype shows it is a naked function - in effect this is just an
//##KIH assembly function. */
//##KIH static void HardFault_Handler( void ) __attribute__( ( naked ) );
...
void NMI_Handler(void)
{
	...
	xt_software_reset(XT_SWRST_NMI);
}
...
void HardFault_Handler(void)
{
	...
	xt_software_reset(XT_SWRST_HARDFAULT);
}
...
void MemManage_Handler(void)
{
	...
	xt_software_reset(XT_SWRST_MEMMANAGE);
}
...
void BusFault_Handler(void)
{
	...
	xt_software_reset(XT_SWRST_BUSFAULT);
}
...
void UsageFault_Handler(void)
{
	...
	xt_software_reset(XT_SWRST_USAGEFAULT);
}
...
void DebugMon_Handler(void)
{
	...
	xt_software_reset(XT_SWRST_DEBUGMON);
}
