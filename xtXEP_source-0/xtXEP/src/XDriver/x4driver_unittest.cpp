...
{    
    ...
    x4driver_get_downconvertion_coef_c1_i_length(&c1i_size);
    ASSERT_NE(c1i_size,0);
    x4driver_get_downconvertion_coef_c1_q_length(&c1q_size);
    ...
    q1ib.data = c1i_data;
    x4driver_get_downconvertion_coef_c1_i(&q1ib);
    ...
    c1qb.data = c1q_data;
    x4driver_get_downconvertion_coef_c1_q(&c1qb);
