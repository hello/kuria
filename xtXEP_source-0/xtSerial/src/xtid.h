...
#define XTS_ID_APP_TRUEPRESENCE     0x014d4ab8
...
#define XTS_ID_TRUEPRESENCE_SINGLE                      0x723bfa1e
#define XTS_ID_TRUEPRESENCE_MOVINGLIST                  0x723bfa1f
#define XTS_ID_PROFILE_PARAMETERFILE                    0x32ba7623
static const uint32_t XTS_ID_BASEBAND_IQ =              0x0000000c;
static const uint32_t XTS_ID_BASEBAND_AMPLITUDE_PHASE = 0x0000000d;
...
#define XTS_VAL_TRUEPRESENCE_PRESENCESTATE_NO_PRESENCE      0 // No presence detected
#define XTS_VAL_TRUEPRESENCE_PRESENCESTATE_PRESENCE         1 // Presence detected
#define XTS_VAL_TRUEPRESENCE_PRESENCESTATE_INITIALIZING     2 // The sensor initializes after the True Presence Profile is executed
#define XTS_VAL_TRUEPRESENCE_PRESENCESTATE_UNKNOWN          3 // The sensor is in an unknown state and requires a Profile and User Settings to be loaded
