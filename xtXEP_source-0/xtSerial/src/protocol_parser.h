...
typedef void (*McpProfileSetProfileParameterFileCallback)(uint32_t filename_length, uint32_t data_length, const char * filename, const char * data, void * user_data);
typedef void (*McpProfileGetProfileParameterFileCallback)(uint32_t filename_length, const char * filename, void * user_data);
...
// X4Driver messages
typedef void (*McpX4DriverSetFpsCallback)(uint32_t fps, void * user_data);
...
// Unknown message
typedef void (*McpUnknownCallback)(uint8_t* data, uint32_t length, void * user_data);
...
typedef struct
{
    ...
    McpProfileSetProfileParameterFileCallback onMcpProfileSetProfileParameterFile;
    McpProfileGetProfileParameterFileCallback onMcpProfileGetProfileParameterFile;
